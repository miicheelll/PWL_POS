        ...
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <div class="form-group"> 
                    <label>ID Stok</label> 
                    <input value="{{ $stok->stok_id }}" type="text" name="stok_id" 
                    id="stok_id" class="form-control" required> 
