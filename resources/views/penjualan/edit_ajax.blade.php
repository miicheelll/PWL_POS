        ...
        <div class="modal-content"> 
            ...
            <div class="modal-body"> 
                <div class="form-group"> 
                    ...
                    <input value="{{ $penjualan->penjualan_id }}" type="text" name="penjualan_id" 
                    id="penjualan_id" class="form-control" required> 
                ...
                <div class="form-group"> 
                    <label>Tanggal</label> 
                    <input value="{{ $penjualan->penjualan_tanggal }}" type="text" name="penjualan_tanggal" id="penjualan_tanggal" 
                    class="form-control" required> 
